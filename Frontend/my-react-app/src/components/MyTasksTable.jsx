        ...
        <>
            <table style={{ width: '100%', borderCollapse: 'collapse', borderRadius: '10px', overflow: 'hidden', marginTop: '16px', tableLayout: 'fixed' }}>
                <thead style={{ backgroundColor: '#f7fafc' }}>
                    <tr>
                        <th style={{ width: '5%', color: '#4a5568', fontWeight: 800, fontSize: '15px', padding: '10px', textAlign: 'left' }}>Sr.</th>
                        ...
                        <th style={{ width: '10%', color: '#4a5568', fontWeight: 800, fontSize: '15px', padding: '10px', textAlign: 'left' }}>Due Date</th>
                    </tr>
                </thead>
                <tbody>
                    {sortedTasks.length > 0 ? (
                        sortedTasks.map((task, index) => {
                            ...
                            return (
                                ...
                                >
                                    <td style={{ padding: '10px' }}>{taskNumber}</td>
